...
function updateData() {
    ...
    if (options.season != 3) {
        ...
        object = document.getElementById('current_day');
        value = parseInt(object.value, 10);
        if (isNaN(value) || value <= 0) {
            value = 1;
            object.value = value;
        } else if (value > 28 && options.season != 3) {
            value = 28;
            object.value = value;
        }
        options.days = 29 - value;
    } else {
        ...
        object = document.getElementById('number_days');
        value = parseInt(object.value, 10);
        if (isNaN(value) || value <= 0) {
            value = 1;
            object.value = value;
        } else if (value > 100000 && options.season == 3) {
            value = 100000;
            object.value = value;
        }
        options.days = value;
    ...
    object = document.getElementById('number_planted');
    value = parseInt(object.value);
    if (isNaN(value) || value <= 0) {
        value = 1;
        object.value = value;
    }
    options.planted = value;

    object = document.getElementById('select_produce');
    value = parseInt(object.value);
    if (isNaN(value)) {
        value = 0;
        object.value = value;
    }
    options.produce = value;
    ...
    object = document.getElementById('select_fertilizer');
    value = parseInt(object.value);
    if (isNaN(value)) {
        value = 0;
        object.value = value;
    }
    options.fertilizer = value;

    options.buyFert = document.getElementById('check_buyFert').checked;

    object = document.getElementById('number_level');
    value = parseInt(object.value);
    if (isNaN(value) || value < 0) {
        value = 0;
        object.value = value;
